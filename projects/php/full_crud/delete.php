        ...
        <div class="card bg-light mx-auto "
            ...
            <div class="d-flex gap-2 p-2 m-2">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <?php echo "<button class=\"btn btn-danger w-50 my-3 mx-auto \"><a href='delete-confirmation.php?id=" . $row['id'] . "&character_name=" . urlencode($row['character_name']) . "' class=\"text-white nav-link p-2 mx-auto\" style=\"font-size:24px; font-weight:bold;\">Delete</a></button>"; ?>
                <?php endif ?>
    ...
    <nav aria-label="Page Number" class="mt-5">
        <ul class="pagination justify-content-center">
            ...
            <?php if ($current_page > 1): ?>
                <li class="page-item">
                    <a href="delete.php?page=<?= $current_page - 1; ?>&number-of-results=<?= $per_page; ?>"
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                <?php else: ?>
                    <li class="page-item">
                        <a href="delete.php?page=<?= $i; ?>&number-of-results=<?= $per_page; ?>"
